...
names = {1: ["Треугольник", np.array([119, 101, 73]), np.array([255, 255, 255]),       90, np.array([0, 0, 0]), np.array([255, 255, 254])], # !!!! -
         2: ["Ведуться работы", np.array([20, 71, 71]), np.array([56, 255, 255]),      80, np.array([30, 30, 255]), np.array([255, 255, 255])],
         3: ["Пешеходный переход", np.array([98, 57, 60]), np.array([163, 255, 255]),  92, np.array([25, 82, 117]), np.array([255, 255, 253])], # !!!!
         4: ["Стоянка", np.array([98, 57, 60]), np.array([163, 255, 255]),             80, np.array([16, 82, 17]), np.array([233, 230, 254])],
         5: ["Кирпич", np.array([119, 101, 73]), np.array([255, 255, 255]),            90, np.array([0, 0, 0]), np.array([255, 255, 254])],
         6: ["Стоп", np.array([119, 101, 73]), np.array([255, 255, 255]),              90, np.array([0, 0, 0]), np.array([255, 255, 254])],
         7: ["Осторожно", np.array([119, 101, 73]), np.array([255, 255, 255]),         90, np.array([0, 0, 0]), np.array([255, 255, 254])],
         8: ["Шипы", np.array([119, 101, 73]), np.array([255, 255, 255]),              90, np.array([0, 0, 0]), np.array([255, 255, 254])],
